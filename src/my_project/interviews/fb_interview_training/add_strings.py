...
class Solution:
    ...
    def addStrings(self, num1: str, num2: str) -> str:
        ...
        for i in range(len_num1):
            numeric_num1 += dic_num[num1[i]]*(10**(len_num1-1-i))

        numeric_num2 = 0
        for i in range(len_num2):
            numeric_num2 += dic_num[num2[i]]*(10**(len_num2-1-i))
...
class Solution:
    def addStrings(self, num1: str, num2: str) -> str:
        ...
        for digit1, digit2 in zip(reversed(num1), reversed(num2)):
            num=ord(digit1)+ord(digit2)-96+remainder
            if num<10:
                res.appendleft(str(num))
                remainder=0
            else:
                res.appendleft(str(num-10))
                remainder=1
        if remainder:
            res.appendleft("1")
        return "".join(res)
