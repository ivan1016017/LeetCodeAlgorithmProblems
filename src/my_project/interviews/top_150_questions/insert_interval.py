...
class SolutionTwo:
    def _binaryInsert(self, newInterval, intervals):
        left = 0
    ...
    def merge(self, intervals, index):
    ...
    def insert(self, intervals: List[List[int]], newInterval: List[int]) -> List[List[int]]:
        ...
        index = self._binaryInsert(newInterval, intervals)

        intervals.insert(index, newInterval)

        return self.merge(intervals, index)
