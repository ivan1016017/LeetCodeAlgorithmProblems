...
class Solution:
    ...
    def isSymmetric(self, root: Optional[TreeNode]) -> bool:
        ...
        return self.selfMirror(root,root)

    def selfMirror(self,subtree1:TreeNode,subtree2:TreeNode) -> bool:
        ...
        if subtree1 is not None and subtree2 is not None: 
            ...
            if subtree1.val == subtree2.val: 
                return self.selfMirror(subtree1.left,subtree2.right) and self.selfMirror(subtree1.right,subtree2.left)
