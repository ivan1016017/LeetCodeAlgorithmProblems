...
class Solution:
    ...
    def hasPathSum(self, root: TreeNode, targetSum: int) -> bool:
        ...
        if root is None: 
            ...
            if temp_sum == 0 and root.left is None and root.right is None: 
                return True 
            if root.left is not None: 
                result = result or self.hasPathSum(root.left,temp_sum)
            if root.right is not None:
                result = result or self.hasPathSum(root.right,temp_sum)
        return result
