...
class Solution:
    ...
    def checkSubarraySum(self, nums: List[int], k: int) -> bool:
        ...
        for i,n in enumerate(nums):
            ...
            sum_value = (sum_value + n) % k


            if sum_value not in dic_solution:
                dic_solution[sum_value] = i 
            else: 
                if i - dic_solution[sum_value] >=2:
                    return True 
...
print(factory('sdfsd').checkSubarraySum(nums = [23,2,4,6,7], k = 6))
# print(factory('sdfsd').checkSubarraySum(nums = [23,2,4,6,7], k = 6))
