...
class Solution:
    ...
    __name_of_intance = 'SolutionOne'

    def __init__(self) -> None: 
        if Solution.__name_of_intance != 'SolutionOne':
            raise Exception('This is a singleton class')
        else: 
            Solution.__name_of_intance = self 

    @abstractmethod
    def get_instance(self) -> None: 
        print(Solution.__name_of_intance)
...
print(factory('sdfds').maxProfit(prices = [7,1,5,3,6,4]))
# print(factory('sdfds').maxProfit(prices = [7,1,5,3,6,4]))
