...
class Solution:
    ...
    def longestPalindrome(self, s):
        ...
        for i in range(len(s)):
            # check the odd length case "aba"
            temp,len_temp = self.helper(s,i,i)
            if len_temp > len(answer):
                answer = temp 
            # check the even lenght case "abba"
            temp, len_temp = self.helper(s,i,i+1)
            if len_temp > len(answer):
                answer = temp 
        return answer 
...
print(factory('sdfds').longestPalindrome(s = "babad"))
# print(factory('sdfds').longestPalindrome(s = "babad"))
