...
class Solution:
    ...
    def lengthOfLongestSubstring(self, s: str) -> int:
        ...
        for i in range(len(s)):
            ...
            if s[i] in dict_solution and start <= dict_solution[s[i]]:
                start = dict_solution[s[i]] + 1
            else: 
    ...
    def lengthOfLongestSubstring(self, s: str) -> int:
        ...
        if len(s) == 1:
            ...
            for i in range(len(s)-1):
                ...
                max_length.append(len(self.largest_chain(s[i:])))
            try:
                max(max_length)
            except:
                return 0
...
print(factory('sdfsd').lengthOfLongestSubstring(s = "abcabcbb"))
# print(factory('sdfsd').lengthOfLongestSubstring(s = "abcabcbb"))
