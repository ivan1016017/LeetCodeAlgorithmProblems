...
class SolutionTwo:
    def kidsWithCandies(self, candies: List[int], extraCandies: int) -> List[bool]:
        ...
        max_candies: int = 0
        len_candies: int = len(candies)
        
        for item in candies:
            if item > max_candies:
                max_candies = item 
        
        solution: List[boolean] = [False for _ in range(len_candies)]
...
print(factory('sdfasdf').kidsWithCandies(candies = [2,3,5,1,3], extraCandies = 3))
# print(factory('sdfasdf').kidsWithCandies(candies = [2,3,5,1,3], extraCandies = 3))
