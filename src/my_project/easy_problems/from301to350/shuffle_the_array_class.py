...
class SolutionTwo:
    def shuffle(self, nums: List[int], n: int) -> List[int]:
        ...
        half_len_nums = len_nums//2
        solution: List[int] = [0 for _ in nums]
        
        for i in range(half_len_nums):
            solution[i*2] = nums[i]
            solution[i*2 + 1] = nums[half_len_nums + i]
...
print(factory('asdf').shuffle([1,2,3,4,5,6],3))
# print(factory('asdf').shuffle([1,2,3,4,5,6],3))
